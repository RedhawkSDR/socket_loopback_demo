# RPM package for socket_loopback_demo
...
%__install -m 644 socket_loopback_demo.sad.xml $RPM_BUILD_ROOT%{_prefix}/dom/waveforms/%{name}/socket_loopback_demo.sad.xml

%files
%defattr(-,redhawk,redhawk)
%dir %{_prefix}/dom/waveforms/%{name}
%{_prefix}/dom/waveforms/%{name}/socket_loopback_demo.sad.xml
